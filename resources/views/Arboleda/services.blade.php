...
@section('contenido')
    ...
    <section class="home-slider owl-carousel">
      <div class="slider-item" style="background-image: url('tasty/images/bg_4.jpg');" data-stellar-background-ratio="0.5">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-3 promo ftco-animate">
            <a href="#" class="promo-img mb-4" style="background-image: url(tasty/images/promo-1.jpg);"></a>
          ...
          <div class="col-lg-3 promo ftco-animate">
            <a href="#" class="promo-img mb-4" style="background-image: url(tasty/images/promo-2.jpg);"></a>
            <div class="text text-center">
              <h2>Beach Tours</h2>
          ...
          <div class="col-lg-3 promo ftco-animate">
            <a href="#" class="promo-img mb-4" style="background-image: url(tasty/images/promo-3.jpg);"></a>
            <div class="text text-center">
