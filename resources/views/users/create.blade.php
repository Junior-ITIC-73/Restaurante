...
<body>
	<center>
		...
		<form method="POST" action="{{route('users.store')}}">
			...
			<input type="num" name="telefono_user" id="telefono" value="{{old('telefono_user')}}">
			<br>
			...
			<input type="num" name="num_interior" id="num_interior" value="{{old('num_interior')}}">
			<br>
			...
			<input type="num" name="num_exterior" id="num_exterior" value="{{old('num_exterior')}}">
			<br>
			...
			<input type="num" name="CP" id="CP" value="{{old('CP')}}"> 
			<br>
			@if($errors->has('CP'))
