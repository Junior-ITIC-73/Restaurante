        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <a class="navbar-brand" href="{{ url('/perfil') }}">
                    RESTAURANTE ARBOLEDA
                </a>

                    <li><a href="{{ url('/menuplatillo') }}">Menu Platillo</a></li>
                    <li><a href="{{ url('/clienteadmin') }}"></a></li>
                    <li><a href="{{ url('/proveedoradmin') }}">proveedor</a></li>
                    ...
                    @else
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="{{ url('/passwordadmin') }}"><span class="fa-passwd-reset fa-stack">
                                        <i class="fa fa-undo fa-stack-2x"></i>
                                        <i class="fa fa-lock fa-stack-1x"></i>
                                        </span> <label>Cambiar Contraseña</label>
                                    </a>
                                </li>
