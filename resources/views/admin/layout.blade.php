...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <aside class="menu-sidebar2">
            <div class="logo">
                <a href="#">
                    <img src="{{asset('adminstyles/images/icon/logo-white.png')}}" alt="Cool Admin" />
                </a>
            </div>
                    ...
                    <div class="container-fluid">
                        <div class="header-wrap2">
                            <div class="logo d-block d-lg-none">
                                <a href="#">
                                    <img src="{{asset('adminstyles/images/icon/logo-white.png')}}" alt="CoolAdmin" />
                                </a>
                            </div>
    ...
    <!-- Vendor JS       -->
    <script src="{{asset('adminstyles/vendor/slick/slick.min.js')}}">
    </script>
    ...
    <script src="{{asset('adminstyles/vendor/bootstrap-progressbar/bootstrap-progressbar.min.js')}}">
    </script>
    <script src="{{asset('adminstyles/vendor/counter-up/jquery.waypoints.min.js')}}"></script>
    <script src="{{asset('adminstyles/vendor/counter-up/jquery.counterup.min.js')}}">
    </script>
    ...
    <script src="{{asset('adminstyles/vendor/select2/select2.min.js')}}">
    </script>
    <script src="{{asset('adminstyles/vendor/vector-map/jquery.vmap.js')}}"></script>
    <script src="{{asset('adminstyles/vendor/vector-map/jquery.vmap.min.js')}}"></script>
    <script src="{{asset('adminstyles/vendor/vector-map/jquery.vmap.sampledata.js')}}"></script>
    <script src="{{asset('adminstyles/vendor/vector-map/jquery.vmap.world.js')}}"></script>
